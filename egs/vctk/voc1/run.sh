...
#/workspace/ParallelWaveGAN/parallel_wavegan/bin/get_angle_stat.py --config conf/ms_melgan.v1.yaml  --dumpdir . --verbose 1 --scp dump/train_nodev_all/raw/wav_aa.scp
#echo parallel-wavegan-compute-statistics \
#    --config "${conf}" \
