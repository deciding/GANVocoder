...
def get_spk_id(utt_id):
    return utt_id.split('-')[0].split('_')[0]
...
def get_angle(audio,
    ...
    phase = np.angle(x_stft).T  # (#frames, #bins)
...
def main():
    ...
    parser.add_argument("--num_spk", type=int, default=10,
                        help="number of speakers ")
    parser.add_argument("--num_utt", type=int, default=20,
                        help="number of speakers ")
    ...
    np.save(os.path.join(args.dumpdir, "angles.npy"),
            phase_map)
